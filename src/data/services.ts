...
export const servicesData: Record<string, ServiceData> = {
  ...
  "mobile-applications": {
    ...
    technologies: ["Flutter", "React Native", "Firebase", "Google Cloud", "FCM", "Crashlytics", "REST/GraphQL", "Git/GitHub"],
    process: [
      { step: "01", title: "Discover", description: "Define user journeys, platforms, and technical requirements." },
      { step: "02", title: "Design", description: "Wireframes, UI mockups, and prototype reviewed with stakeholders." },
      { step: "03", title: "Build", description: "Iterative development with weekly demos and QA across devices." },
      { step: "04", title: "Launch", description: "App Store & Play Console submission, monitoring, and post-launch support." },
    ],
  },
  "web-applications": {
    ...
    technologies: ["React", "Next.js", "Node.js", "Python", "Django", "PostgreSQL", "MongoDB", "AWS", "Docker", "GitHub Actions"],
    process: [
      { step: "01", title: "Scope", description: "Define features, architecture, and delivery milestones." },
      { step: "02", title: "Design", description: "System design, data models, and UI/UX prototypes." },
      { step: "03", title: "Build", description: "Agile sprints with continuous integration and stakeholder reviews." },
      { step: "04", title: "Ship", description: "Production deployment, monitoring, and knowledge transfer." },
    ],
  },
  websites: {
    title: "Websites",
    ...
    technologies: ["Next.js", "Tailwind CSS", "Sanity", "Contentful", "Vercel", "Cloudflare", "TypeScript"],
    process: [
      { step: "01", title: "Brief", description: "Understand brand, goals, target audience, and content structure." },
      { step: "02", title: "Design", description: "Figma designs reviewed and approved before development begins." },
      { step: "03", title: "Build", description: "Pixel-perfect responsive development with CMS wiring." },
      { step: "04", title: "Launch", description: "Performance audit, SEO checks, and go-live on your domain." },
    ],
  },
  "sharepoint-power-platform": {
    ...
    technologies: ["SharePoint Online", "Power Apps", "Power Automate", "Microsoft Azure", "SQL Server", "Microsoft 365", "JavaScript", "HTML/CSS"],
    process: [
      { step: "01", title: "Assess", description: "Audit your current Microsoft 365 environment and identify collaboration gaps." },
      { step: "02", title: "Design", description: "Architect SharePoint sites, data models, and Power Platform solutions." },
      { step: "03", title: "Build", description: "Develop and configure portals, apps, and automated workflows." },
      { step: "04", title: "Adopt", description: "User training, governance setup, and ongoing platform administration." },
    ],
  },
};
